  ...
  const classes = useStyles();
    ...
    return (
      ...
      <div className="container valign-wrapper" style={{ height: 'auto' }}>
        ...
        <a href="https://github.com/TylerSilverman/TylerSilverman.github.io/files/6212765/Resume-Tyler.Silverman.pdf"  className="btn btn-small waves-effect waves-light hoverable yellow accent-6" style={{
              width: '120px',
              borderRadius: '50px',
              letterSpacing: '3px',
              font:'bold',
...
Please feel free to click on the buttons below to check out my projects that I have developed.
      ...
      <div className="container valign-wrapper " style={{ height: '80vh' }}>
        ...
        <b><a href="https://tylersilvermanforum.herokuapp.com/" className="btn btn-small waves-effect waves-light hoverable yellow accent-3" style={{
              width: '300px',
              borderRadius: '70px',
              letterSpacing: '1px',
              font:'bold',
              color: 'black',
            }}>Social Forum Blog</a></b>
