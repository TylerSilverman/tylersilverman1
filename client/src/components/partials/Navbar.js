  ...
  return (
    <div>
     ...
     <div class="jumbotron text-center">
        ...
        <a href="https://github.com/TylerSilverman/TylerSilverman.github.io/files/6651135/TylerSilverman-Resume.pdf" target="_blank"><i class="btn btn-small blue" onClick={() => {
